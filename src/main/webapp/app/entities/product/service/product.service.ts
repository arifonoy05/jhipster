...
export class ProductService {
    ...
    update(product: IProduct): Observable<EntityResponseType> {
        return this.http.put<IProduct>(`${this.resourceUrl}/${this.getProductIdentifier(product)}`,
                 product ,
                { observe: 'response' })
        ;
    }
    ...
    partialUpdate(product: PartialUpdateProduct): Observable<EntityResponseType> {
        return this.http.patch<IProduct>(`${this.resourceUrl}/${this.getProductIdentifier(product)}`,
                 product ,
                { observe: 'response' })
        ;
    }
    ...
    addProductToCollectionIfMissing<Type extends Pick<IProduct, 'id'>>(productCollection: Type[], ...productsToCheck: (Type | null | undefined)[]): Type[] {
